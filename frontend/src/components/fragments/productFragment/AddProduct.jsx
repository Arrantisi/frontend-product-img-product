...
const AddProduct = () => {
  ...
  return (
    <div
      ...
      className={`${
        close && "hidden"
      } overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 bg-gray-700/70  flex justify-center items-center w-full md:inset-0 h-modal md:h-full`}
    >
      {alert && <Alert status={"info"} text={error} />}
              ...
              <div className="col-span-2">
                ...
                <label
                  className={`flex items-center justify-center flex-col ${
                    preview ? "h-64" : "h-36"
                  } w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 hover:bg-gray-50/30 cursor-pointer`}
                >
                  {preview ? (
                    <figure className="h-[15rem] w-[15rem]">
